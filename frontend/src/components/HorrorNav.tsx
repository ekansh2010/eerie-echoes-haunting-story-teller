          ...
          <div className="flex items-center gap-1">
            ...
            {user ? (
              <div className="flex items-center gap-1 ml-2">
                <span className="text-xs text-primary font-typewriter hidden md:inline border-r border-border pr-3">
                  {user.username}
                </span>
                <button
                  onClick={logout}
                  className="flex items-center gap-2 px-3 py-2 rounded-md text-sm text-muted-foreground hover:text-primary hover:bg-secondary transition-colors"
                >
                  <LogIn className="w-4 h-4 rotate-180 text-primary" />
